INSERT INTO `owners` ( `username`, `password`, `lasttime`,`blockedtime`, `secondsblocked`) VALUES ("test", "$2b$10$YOmPxgHMM2UMqxiYPN7jl.A2noHHbeIYuu177T5gotvx.UpL9TJ6K",NOW(),1,1);
INSERT INTO `owners` ( `username`, `password`, `manager`,`lasttime`,`blockedtime`,`secondsblocked`) VALUES ("man", "$2b$10$5OP4Z6d7mCRcf3msIm6DsOiWIhcysiU/lzg5HWkkLzzOosYm7Gsxm", 1,NOW(),1,1);
...
( 400.0, 0.1, 400.0, 200.0, 50.0, 10000.0, 0);
